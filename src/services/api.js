...
export async function addPlugin(params) {
  ...
  return request(`${baseUrl}/plugin_template`, {
    method: `POST`,
    body: formData,
  });
}
...
export async function generatePlugin({ pluginId, namespaceId }) {
  return request(`${baseUrl}/namespace_plugin/${namespaceId}/${pluginId}`, {
    method: `PUT`,
  });
}
...
export async function deletePlugin(params) {
  return request(`${baseUrl}/plugin_template/batch`, {
    method: `DELETE`,
    body: [...params.list],
  });
}
...
export async function updatePlugin(params) {
  ...
  return request(`${baseUrl}/plugin_template/${params.id}`, {
    method: `PUT`,
    body: formData,
  });
}
...
export async function getAllPlugins(params) {
  return request(`${baseUrl}/plugin_template?${stringify(params)}`, {
    method: `GET`,
  });
}
...
export async function getPluginsByNamespace(params) {
  return request(`${baseUrl}/namespace_plugin?${stringify(params)}`, {
    method: `GET`,
  });
}
...
export function activePluginSnapshot() {
  return request(`${baseUrl}/plugin_template/snapshot/active`, {
    method: `GET`,
  });
}
...
export function activePluginSnapshotByNamespace(params) {
  return request(
    `${baseUrl}/namespace_plugin/snapshot/active?namespaceId=${params.namespaceId}`,
    {
      method: `GET`,
    },
  );
...
export async function updatepluginEnabled(params) {
  return request(`${baseUrl}/plugin_template/enabled`, {
    method: `POST`,
    body: {
      ids: params.list,
      enabled: params.enabled,
...
export async function asyncOnePlugin(params) {
  return request(`${baseUrl}/namespace_plugin/syncPluginData?id=${params.id}`, {
    method: `PUT`,
  });
}
...
export async function asyncByPluginAndNamespace(params) {
  return request(
    `${baseUrl}/namespace_plugin/syncPluginData?id=${params.id}&namespaceId=${params.namespaceId}`,
    {
      method: `PUT`,
    },
  );
...
export async function getPluginDropDownList() {
  return request(`${baseUrl}/plugin_template/all`, {
    method: `GET`,
  });
}
...
export async function getPluginDropDownListByNamespace(params) {
  return request(
    `${baseUrl}/plugin_template/listByNamespace?namespace=${params.namespace}`,
    {
      method: `GET`,
    },
  );
...
export function addPluginResource(params) {
  return request(
    `${baseUrl}/plugin_template/createPluginResource/${params.id}`,
    {
      method: `PUT`,
      body: params,
    },
...
export async function findNamespacePlugin(params) {
  return request(`${baseUrl}/namespace_plugin/${params.id}`, {
    method: `GET`,
  });
}
...
export async function updateNamespacePluginEnabled(params) {
  return request(`${baseUrl}/namespace_plugin/enabled`, {
    method: `POST`,
    body: {
      ids: params.list,
      enabled: params.enabled,
...
export async function updateNamespacePluginEnabledByNamespace(params) {
  return request(`${baseUrl}/namespace_plugin/enabledByNamespace`, {
    method: `POST`,
    body: {
      ids: params.list,
      enabled: params.enabled,
...
export async function deleteNamespacePlugin(params) {
  return request(`${baseUrl}/namespace_plugin/batch`, {
    method: `DELETE`,
    body: {
      ids: [...params.list],
      namespaceId: params.namespaceId,
...
export async function asyncNamespacePlugin() {
  return request(`${baseUrl}/namespace_plugin/syncPluginAll`, {
    method: `POST`,
  });
}
