...
export default class Dubbo extends Component {
  ...
  rowClick = record => {
    ...
    const { dispatch } = this.props;
    dispatch({
      type: "dubbo/saveCurrentSelector",
      payload: {
